...
function calcQuantity(e) {
    ...
    const sumBase = flourBase + waterBase + sourdoughBase + saltBase;
    document.getElementById("sumBase").innerHTML = sumBase;
    document.getElementById("hydrationRate").innerHTML = Math.round(waterBase/flourBase * 10000) / 100;
    document.getElementById("sourdoughRate").innerHTML = Math.round(sourdoughBase/sumBase * 10000) / 100;
    ...
    document.getElementById("sumRequired").innerHTML = Math.round(flourRequired + waterRequired + sourdoughRequired + saltRequired);
}

function initVal(flour, water, salt, sourdough, wanted) {
